                        ...
                        <tr class="border-b hover:bg-gray-100">
                            ...
                            <td class="px-4 py-2">
                                @if($item->status == 'Menunggu Konfirmasi')
                                    <span class="bg-yellow-200 text-yellow-900 text-xs font-semibold px-2 py-1 rounded-full whitespace-nowrap">{{ $item->status }}</span>
                                @elseif($item->status == 'Dipinjam')
                                    <span class="bg-green-200 text-green-900 text-xs font-semibold px-2 py-1 rounded-full">{{ $item->status }}</span>
                                @endif
                            </td>
                        </tr>
                        @empty
